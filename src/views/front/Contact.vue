      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:flex-col sm:align-center">
          <div class="relative max-w-xl mx-auto py-12 sm:py-6 w-full overflow-hidden">
            <svg class="absolute left-full transform translate-x-1/2" width="404" height="404"
              fill="none" viewBox="0 0 404 404" aria-hidden="true">
              <defs>
                <pattern id="85737c0e-0916-41d7-917f-596dc7edfa27" x="0" y="0" width="20"
                  height="20" patternUnits="userSpaceOnUse">
                  <rect x="0" y="0" width="4" height="4" class="text-gray-200 dark:text-black"
                    fill="currentColor" />
                </pattern>
              </defs>
            ...
            <div class="mt-12">
              <WarningBanner v-if="!actionURL" :title="$t('shared.notSet')"
              ...
              <form :action="actionURL" method="POST"
                ...
                <div>
                  ...
                  <div class="mt-1">
                    <input required v-model="firstName" type="text" name="first_name"
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <input v-model="organization" type="text" name="company" id="company"
                ...
                <fieldset class="sm:col-span-2">
                  <legend class="block text-sm font-medium text-gray-900 dark:text-slate-300">{{
                      $t("front.contact.users")
                  }}</legend>
                  <div class="mt-4 grid grid-cols-1 gap-y-4">
                    <select id="users" required v-model="users"
                      class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-slate-200 appearance-none rounded-none relative block w-full px-3 py-2 border-gray-300 dark:border-gray-600 placeholder-gray-500 rounded-b-sm focus:outline-none focus:ring-theme-300 focus:border-theme-300 focus:z-10 sm:text-sm">
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <textarea required v-model="comments" id="comments" name="comments"
                      aria-describedby="comments_description" rows="4"
                      class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-slate-200 appearance-none rounded-none relative block w-full px-3 py-2 border-gray-300 dark:border-gray-600 placeholder-gray-500 rounded-b-sm focus:outline-none focus:ring-theme-300 focus:border-theme-300 focus:z-10 sm:text-sm"></textarea>
                  </div>
                </div>
