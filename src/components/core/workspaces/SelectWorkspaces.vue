...
export default defineComponent({
  ...
  setup(_, context) {
    ...
    const filteredItems = computed((): WorkspaceDto[] => {
      ...
      return items.value.filter((f) => f.id?.toUpperCase().includes(searchInput.value.toUpperCase()) || f.name?.toString().toUpperCase().includes(searchInput.value.toUpperCase()));
    })
