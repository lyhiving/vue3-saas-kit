...
export const AppSidebar: SideBarItem[] = [
  {
    title: i18n.global.t("app.sidebar.app"),
    path: "",
    items: [
      {
      ...
      {
        title: i18n.global.t("models.link.plural"),
        path: "/app/links/all",
        icon: SvgIcon.LINKS,
        userRoles: [TenantUserRole.OWNER, TenantUserRole.ADMIN],
        items: [
          {
            title: i18n.global.t("shared.all"),
            path: "/app/links/all",
          },
          {
            title: i18n.global.t("models.provider.plural"),
            path: "/app/links/providers",
          },
          {
            title: i18n.global.t("models.client.plural"),
      ...
      {
        title: i18n.global.t("models.employee.plural"),
        path: "/app/employees",
        icon: SvgIcon.EMPLOYEES,
        userRoles: [TenantUserRole.OWNER, TenantUserRole.ADMIN, TenantUserRole.MEMBER],
      },
      {
        title: i18n.global.t("app.navbar.settings"),
        icon: SvgIcon.SETTINGS,
        userRoles: [TenantUserRole.OWNER, TenantUserRole.ADMIN],
        path: "/app/settings",
        items: [
          {
            title: i18n.global.t("app.navbar.profile"),
          ...
          {
            title: i18n.global.t("settings.members.title"),
            path: "/app/settings/members",
            userRoles: [TenantUserRole.OWNER, TenantUserRole.ADMIN],
          },
          {
            title: i18n.global.t("settings.subscription.title"),
            path: "/app/settings/subscription",
            userRoles: [TenantUserRole.OWNER],
          },
          {
            title: i18n.global.t("app.navbar.tenant"),
